...
| `aivi.db` | **Implemented** | Backed by `runtime/builtins/database.rs`. Supports SQLite, PostgreSQL, MySQL. Features `runMigrations`, `applyDelta` (CAS), and full table management. |
